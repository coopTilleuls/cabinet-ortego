		...
		<div {...blockProps}>
			<div className="info-card">
				...
				{infoItems.map((item, index) => (
					<div key={index} className="info-item" style={{ display: 'flex', gap: '15px', marginBottom: '20px', position: 'relative' }}>
						...
						<div style={{ minWidth: '30px' }}>
							<i className={ICONS[item.icon]?.class || 'fa-solid fa-question'} style={{ color: '#8C1818', fontSize: '1.2rem', marginTop: '5px' }}></i>
							<SelectControl
								value={item.icon}
						...
						<div style={{ flexGrow: 1 }}>
							<RichText
								...
								style={{ fontSize: '1rem', fontWeight: '600', marginBottom: '5px', marginTop: 0 }}
							/>
							<RichText
								tagName="p"
