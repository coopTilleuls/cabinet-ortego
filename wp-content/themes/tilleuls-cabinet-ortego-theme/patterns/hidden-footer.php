...
/**
 * Title: Footer
 * Slug: tilleuls-cabinet-ortego-theme/hidden-footer
 * Inserter: no
 *
...
<div class="wp-block-group has-primary-background-color has-background" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
	...
	<p class="has-small-font-size"><?php echo esc_html__( 'Copyright', 'tilleuls-cabinet-ortego-theme' ) . ' ' . date_i18n( _x( 'Y', 'copyright date format', 'tilleuls-cabinet-ortego-theme' ) ); ?></p>
	<!-- /wp:paragraph -->
