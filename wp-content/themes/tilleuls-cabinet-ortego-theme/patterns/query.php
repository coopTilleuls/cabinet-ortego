...
/**
 * Title: Query
 * Slug: tilleuls-cabinet-ortego-theme/query
 * Categories: posts
...
<div class="wp-block-query">
	<!-- wp:post-template -->
		...
		<!-- wp:pattern {"slug":"tilleuls-cabinet-ortego-theme/hidden-post-meta"} /-->
	...
	<!-- /wp:post-template -->
	<!-- wp:query-no-results -->
	<!-- wp:paragraph --><p><?php esc_html_e( 'No results found.', 'tilleuls-cabinet-ortego-theme'); ?></p><!-- /wp:paragraph -->
	<!-- /wp:query-no-results -->
